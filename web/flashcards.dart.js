...
$$.Element = {"": "Node;hidden},id=,innerHtml:innerHTML%,$$dom_children:children=",
  get$children: function(receiver) {
...
$$.Closure$englishSelected = {"": "Closure;call$1,$name"};

$$.Closure$farsiSelected = {"": "Closure;call$1,$name"};

$$.Closure$latinFarsiSelected = {"": "Closure;call$1,$name"};

$$.Closure$tagsChanged = {"": "Closure;call$1,$name"};

$$.Closure$clickRevealButton = {"": "Closure;call$1,$name"};

$$.Closure$clickRightButton = {"": "Closure;call$1,$name"};

$$.Closure$clickWrongButton = {"": "Closure;call$1,$name"};

$$.Closure$displayData = {"": "Closure;call$1,$name"};
...
_ConstantMapKeyIterable: {"": "IterableBase;_liblib3$_map",
  get$iterator: function(_) {
    return $.get$iterator$ax(this._liblib3$_map._keys);
  },
...
HashMapKeyIterator: {"": "Object;_map,_liblib1$_keys,_offset,_current",
  get$current: function() {
...
ListMixin: {"": "Object;",
  ...
  retainWhere$1: function(receiver, test) {
    $.ListMixin__filter(receiver, test, true);
  },
  removeLast$0: function(receiver) {
    var result;
    if ($.$eq(this.get$length(receiver), 0))
  ...
  toString$0$bailout1: function(state0, t1, t2) {
    switch (state0) {
      ...
      case 1:
        ...
        t2 = this._existingArgumentNames;
      case 2:
        var sb, t3, t4, t5, actualParameters, i, str, formalParameters;
        state0 = 0;
        if (t2 == null)
...
_ChildrenElementList: {"": "ListBase;_element,_childElements",
  ...
  _filter$2: function(test, retainMatching) {
    ...
    for (t1 = new $.WhereIterator($.get$iterator$ax(removed._iterable), removed._f), t2 = t1._iterator; t1.moveNext$0();)
...
FixedSizeListIterator: {"": "Object;_array,_liblib0$_length,_liblib0$_position,_liblib0$_current",
  moveNext$0: function() {
    var nextPosition, t1;
    nextPosition = $.$add$ns(this._liblib0$_position, 1);
...
Card: {"": "Object;english<,farsi<,latinFarsi<,englishScore@,farsiScore@,latinFarsiScore@,tags",
  ...
  toString$0: function(_) {
    return this.english + "|" + this.farsi + "|" + this.latinFarsi + "|" + $.S(this.englishScore) + "|" + $.S(this.farsiScore) + "|" + $.S(this.latinFarsiScore) + "|" + $.S(this.tags);
  },
  toTableRowElement$0: function() {
    var row, t1, cell, result, csv;
    ...
    $.ToString__emitValue(t1, result, $.List_List($));
    csv = result._contents;
    $.set$innerHtml$x(cell, "<input type=\"text\" name=\"tags\" size= \"20\" placeholder=\"Filter tags\" value=\"" + (t1.length > 0 ? $.JSString_methods.substring$2(csv, 1, csv.length - 1) : csv) + "\">\n");
    return row;
  },
  hasTags$1: function(tagsToFilter) {
    var t1, t2, tag;
    for (t1 = new $.ListIterator(tagsToFilter, tagsToFilter.length, 0, null), t2 = this.tags; t1.moveNext$0();) {
...
englishSelected_closure: {"": "Closure;",
  call$2: function(e, e2) {
    return e.compareEnglishScore$1(e2);
  }
},

farsiSelected_closure: {"": "Closure;",
  call$2: function(e, e2) {
    return e.compareFarsiScore$1(e2);
  }
},

latinFarsiSelected_closure: {"": "Closure;",
  call$2: function(e, e2) {
    return e.compareLatinFarsiScore$1(e2);
  }
},

tagsChanged_closure: {"": "Closure;tags_0",
  call$1: function(e) {
    return e.hasTags$1(this.tags_0);
  }
},

displayData_closure: {"": "Closure;table_0",
  call$1: function(e) {
...
main: function() {
  ...
  e.initEvent("MouseEvent", true, true);
  $.tagsChanged(e);
...
initialize: function() {
  ...
  t3 = new $._EventStreamSubscription(0, t3._liblib0$_target, t3._eventType, $.englishSelected$closure, t3._useCapture);
  t4 = t3._onData;
  if (t4 != null && !t3.get$isPaused())
    $.$$dom_addEventListener$3$x(t3._liblib0$_target, t3._eventType, t4, t3._useCapture);
  t2.set$checked(t1, true);
  $.englishRadioButton = t1;
  t1 = document.querySelector("input[value=\"farsi\"]");
  t2 = $.get$onClick$x(t1);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, $.farsiSelected$closure, t2._useCapture);
  t3 = t2._onData;
  if (t3 != null && !t2.get$isPaused())
    $.$$dom_addEventListener$3$x(t2._liblib0$_target, t2._eventType, t3, t2._useCapture);
  $.farsiRadioButton = t1;
  t1 = document.querySelector("input[value=\"latinFarsi\"]");
  t2 = $.get$onClick$x(t1);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, $.latinFarsiSelected$closure, t2._useCapture);
  t3 = t2._onData;
  if (t3 != null && !t2.get$isPaused())
    $.$$dom_addEventListener$3$x(t2._liblib0$_target, t2._eventType, t3, t2._useCapture);
  $.latinFarsiRadioButton = t1;
  t1 = document.querySelector("#tags");
  t2 = $.get$onChange$x(t1);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, $.tagsChanged$closure, t2._useCapture);
  t3 = t2._onData;
  if (t3 != null && !t2.get$isPaused())
    $.$$dom_addEventListener$3$x(t2._liblib0$_target, t2._eventType, t3, t2._useCapture);
  $.tagsInput = t1;
  t1 = document.querySelector("#revealButton");
  t2 = $.get$onClick$x(t1);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, $.clickRevealButton$closure, t2._useCapture);
  t3 = t2._onData;
  if (t3 != null && !t2.get$isPaused())
    $.$$dom_addEventListener$3$x(t2._liblib0$_target, t2._eventType, t3, t2._useCapture);
  $.revealButton = t1;
  ...
  t1.hidden = true;
  t2 = $.get$onClick$x(t1);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, $.clickRightButton$closure, t2._useCapture);
  t3 = t2._onData;
  if (t3 != null && !t2.get$isPaused())
    $.$$dom_addEventListener$3$x(t2._liblib0$_target, t2._eventType, t3, t2._useCapture);
  $.rightButton = t1;
  ...
  t1.hidden = true;
  t2 = $.get$onClick$x(t1);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, $.clickWrongButton$closure, t2._useCapture);
  t3 = t2._onData;
  if (t3 != null && !t2.get$isPaused())
    $.$$dom_addEventListener$3$x(t2._liblib0$_target, t2._eventType, t3, t2._useCapture);
  $.wrongButton = t1;
  $.question = document.querySelector("#question");
  t1 = document.querySelector("#answer");
  t1.hidden = true;
  $.answer = t1;
  $.errorParagraph = document.querySelector("#error");
  t1 = document.querySelector("#displayData");
  t2 = $.get$onClick$x(t1);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, $.displayData$closure, t2._useCapture);
  t3 = t2._onData;
  if (t3 != null && !t2.get$isPaused())
    $.$$dom_addEventListener$3$x(t2._liblib0$_target, t2._eventType, t3, t2._useCapture);
  $.displayDataAnchor = t1;
  $.dataDisplayArea = document.querySelector("#dataDisplayArea");
},

englishSelected: function(e) {
  $.Primitives_printString("English selected");
  $.selectedSource = 0;
  $.sort$1$ax($.get$workingDictionary(), new $.englishSelected_closure());
},

farsiSelected: function(e) {
  $.Primitives_printString("Farsi selected");
  $.selectedSource = 1;
  $.sort$1$ax($.get$workingDictionary(), new $.farsiSelected_closure());
},

latinFarsiSelected: function(e) {
  $.Primitives_printString("LatinFarsi selected");
  $.selectedSource = 2;
  $.sort$1$ax($.get$workingDictionary(), new $.latinFarsiSelected_closure());
},

tagsChanged: function(e) {
  var tags, t1, t2;
  $.Primitives_printString($.toString$0($.get$value$x($.tagsInput)));
  tags = $.split$1$s($.get$value$x($.tagsInput), ",");
  t1 = $.List_List$from($.get$dictionary(), true);
  $.retainWhere$1$ax(t1, new $.tagsChanged_closure(tags));
  $.workingDictionary = t1;
  t1 = $.$eq($.get$length$asx($.get$workingDictionary()), 0);
  t2 = $.errorParagraph;
  if (t1)
    ...
    t2.textContent = "";
  $.showNextCard();
  $.click$0$x($.displayDataAnchor);
},

clickRevealButton: function(e) {
  $.preventDefault$0$x(e);
  $.set$hidden$x($.answer, false);
  $.set$hidden$x($.revealButton, true);
  $.set$hidden$x($.rightButton, false);
  $.set$hidden$x($.wrongButton, false);
},

clickRightButton: function(e) {
  $.preventDefault$0$x(e);
  $.set$hidden$x($.answer, true);
  $.set$hidden$x($.revealButton, false);
  $.set$hidden$x($.rightButton, true);
  $.set$hidden$x($.wrongButton, true);
  $.updateCard(1.4);
  $.showNextCard();
},

clickWrongButton: function(e) {
  $.preventDefault$0$x(e);
  $.set$hidden$x($.answer, true);
  $.set$hidden$x($.revealButton, false);
  $.set$hidden$x($.rightButton, true);
...
updateCard: function(scoreAdjustmentFactor) {
  var t1, i, t2;
  $.remove$1$ax($.get$workingDictionary(), $.currentCard);
  if ($.get$checked$x($.englishRadioButton) === true) {
    t1 = $.currentCard;
    t1.set$englishScore(t1.get$englishScore() * scoreAdjustmentFactor);
    i = 0;
    while (true) {
      t1 = $.get$length$asx($.get$workingDictionary());
      if (typeof t1 !== "number")
        throw $.iae(t1);
      if (!(i < t1))
        break;
      if ($.currentCard.get$englishScore() < $.$index$asx($.get$workingDictionary(), i).get$englishScore()) {
        $.insert$2$ax($.get$workingDictionary(), i, $.currentCard);
        break;
      } else {
        t1 = $.$sub$n($.get$length$asx($.get$workingDictionary()), 1);
        if (typeof t1 !== "number")
          throw $.iae(t1);
        if (i >= t1) {
          $.add$1$ax($.get$workingDictionary(), $.currentCard);
          break;
        }
      }
      ++i;
    }
  } else if ($.get$checked$x($.farsiRadioButton) === true) {
    t1 = $.currentCard;
    ...
    while (true) {
      ...
      if (!(i < t1))
        break;
      if ($.currentCard.get$farsiScore() < $.$index$asx($.get$workingDictionary(), i).get$farsiScore()) {
        $.insert$2$ax($.get$workingDictionary(), i, $.currentCard);
        break;
      } else {
        t1 = $.$sub$n($.get$length$asx($.get$workingDictionary()), 1);
  ...
  } else if ($.get$checked$x($.latinFarsiRadioButton) === true) {
    t1 = $.currentCard;
    t2 = t1.get$latinFarsiScore();
    $.throwExpression(new $.NoSuchMethodError("", "get scoreAdjustment", [], $.Map_empty, null));
    if (typeof null !== "number")
      throw $.iae(null);
    t1.set$latinFarsiScore(t2 * null);
  }
},

showNextCard: function() {
  var max, nextInt, t1, t2;
  $.click$0$x($.displayDataAnchor);
  if ($.$eq($.get$length$asx($.get$workingDictionary()), 0))
    return;
  $.get$random();
  max = $.min($.$sub$n($.get$length$asx($.get$workingDictionary()), 1), 4);
  if (max < 0)
    $.throwExpression(new $.ArgumentError("negative max: " + $.S(max)));
  if (max > 4294967295)
    max = 4294967295;
  nextInt = Math.random() * max >>> 0;
  $.Primitives_printString("Choose: " + nextInt);
  $.currentCard = $.$index$asx($.get$workingDictionary(), nextInt);
  t1 = $.answer;
  t2 = $.currentCard;
  $.set$innerHtml$x(t1, t2.get$english() + "&emsp;&emsp;&emsp;" + t2.get$farsi() + "&emsp;&emsp;&emsp;" + t2.get$latinFarsi());
  if ($.get$checked$x($.englishRadioButton) === true)
    $.question.textContent = $.currentCard.get$english();
  else if ($.get$checked$x($.farsiRadioButton) === true)
    $.question.textContent = $.currentCard.get$farsi();
  else if ($.get$checked$x($.latinFarsiRadioButton) === true)
    $.question.textContent = $.currentCard.get$latinFarsi();
},
...
displayData: function(e) {
  ...
  $.forEach$1$ax($.get$workingDictionary(), new $.displayData_closure(table));
  $.set$innerHtml$x($.dataDisplayArea, "");
  $.dataDisplayArea.appendChild(table);
  t1 = $.dataDisplayArea;
  t2 = $.getInterceptor$x(t1);
  t2.set$innerHtml(t1, $.$add$ns(t2.get$innerHtml(t1), "Count: " + $.S($.get$length$asx($.get$workingDictionary()))));
}}],
...
$.englishSelected$closure = new $.Closure$englishSelected($.englishSelected, "englishSelected$closure");
$.farsiSelected$closure = new $.Closure$farsiSelected($.farsiSelected, "farsiSelected$closure");
$.latinFarsiSelected$closure = new $.Closure$latinFarsiSelected($.latinFarsiSelected, "latinFarsiSelected$closure");
$.tagsChanged$closure = new $.Closure$tagsChanged($.tagsChanged, "tagsChanged$closure");
$.clickRevealButton$closure = new $.Closure$clickRevealButton($.clickRevealButton, "clickRevealButton$closure");
$.clickRightButton$closure = new $.Closure$clickRightButton($.clickRightButton, "clickRightButton$closure");
$.clickWrongButton$closure = new $.Closure$clickWrongButton($.clickWrongButton, "clickWrongButton$closure");
$.displayData$closure = new $.Closure$displayData($.displayData, "displayData$closure");
...
$.selectedSource = 0;
$.currentCard = null;
$.englishRadioButton = null;
$.farsiRadioButton = null;
$.latinFarsiRadioButton = null;
$.tagsInput = null;
$.revealButton = null;
$.rightButton = null;
$.wrongButton = null;
...
$.answer = null;
$.errorParagraph = null;
$.displayDataAnchor = null;
$.dataDisplayArea = null;
...
Isolate.$lazy($, "dictionary", "dictionary", "get$dictionary", function() {
  return [new $.Card("alef", "\ufe8d", "alef", 1, 1, 1, ["letter"]), new $.Card("be", "\u0628", "be", 1, 1, 1, ["letter"]), new $.Card("pe", "\u067e", "pe", 1, 1, 1, ["letter"]), new $.Card("te", "\ufe95", "te", 1, 1, 1, ["letter"]), new $.Card("se", "\ufe99", "se", 1, 1, 1, ["letter"]), new $.Card("jim", "\ufe9d", "jim", 1, 1, 1, ["letter"]), new $.Card("che", "\ufb7a", "che", 1, 1, 1, ["letter"]), new $.Card("he", "\ufea1", "he", 1, 1, 1, ["letter"]), new $.Card("khe", "\ufea5", "khe", 1, 1, 1, ["letter"]), new $.Card("daal", "\ufea9", "daal", 1, 1, 1, ["letter"]), new $.Card("zaal", "\ufeab", "zaal", 1, 1, 1, ["letter"]), new $.Card("re", "\ufead", "re", 1, 1, 1, ["letter"]), new $.Card("ze", "\ufeaf", "ze", 1, 1, 1, ["letter"]), new $.Card("zhe", "\u0698", "zhe", 1, 1, 1, ["letter"]), new $.Card("sin", "\ufeb1", "sin", 1, 1, 1, ["letter"]), new $.Card("shin", "\ufeb5", "shin", 1, 1, 1, ["letter"]), new $.Card("saad", "\ufeb9", "saad", 1, 1, 1, ["letter"]), new $.Card("zaad", "\ufebd", "zaad", 1, 1, 1, ["letter"]), new $.Card("ta", "\ufec1", "ta", 1, 1, 1, ["letter"]), new $.Card("za", "\ufec5", "za", 1, 1, 1, ["letter"]), new $.Card("ein", "\ufec9", "ein", 1, 1, 1, ["letter"]), new $.Card("ghein", "\ufecd", "ghein", 1, 1, 1, ["letter"]), new $.Card("fe", "\ufed1", "fe", 1, 1, 1, ["letter"]), new $.Card("qaaf", "\ufed5", "qaaf", 1, 1, 1, ["letter"]), new $.Card("kaaf", "\u06a9", "kaaf", 1, 1, 1, ["letter"]), new $.Card("gaaf", "\u06af", "gaaf", 1, 1, 1, ["letter"]), new $.Card("laam", "\ufedd", "laam", 1, 1, 1, ["letter"]), new $.Card("mim", "\ufee1", "mim", 1, 1, 1, ["letter"]), new $.Card("noon", "\ufee5", "noon", 1, 1, 1, ["letter"]), new $.Card("vav", "\u0648", "vav", 1, 1, 1, ["letter"]), new $.Card("he", "\ufee9", "he", 1, 1, 1, ["letter"]), new $.Card("ye", "\ufeef", "ye", 1, 1, 1, ["letter"]), new $.Card("water", "\u0622\u0628", "ab", 1, 1, 1, ["noun", "food"]), new $.Card("juice", "\u0622\u0628\u0645\u06cc\u0648\u0647", "abmiveh", 1, 1, 1, ["noun", "food"]), new $.Card("beer", "\u0622\u0628\u062c\u0648", "abjo", 1, 1, 1, ["noun", "food"]), new $.Card("wine", "\u0634\u0631\u0627\u0628", "sharab", 1, 1, 1, ["noun", "food"]), new $.Card("milk", "\u0634\u06cc\u0631", "shir", 1, 1, 1, ["noun", "food"]), new $.Card("olive", "\u0632\u06cc\u062a\u0648\u0646", "zeitoon", 1, 1, 1, ["noun", "food"]), new $.Card("chicken", "\u062c\u0648\u062c\u0647", "joojeh", 1, 1, 1, ["noun", "food", "animal"]), new $.Card("beef", "\u06af\u0648\u0634\u062a \u06af\u0627\u0648", "goosht e gav", 1, 1, 1, ["noun", "food"]), new $.Card("lamb", "\u0628\u0631\u0647", "barreh", 1, 1, 1, ["noun", "food"]), new $.Card("bear", "\u062e\u0631\u0633", "khers", 1, 1, 1, ["noun", "animal"]), new $.Card("tiger", "\u0628\u0628\u0631", "babr", 1, 1, 1, ["noun", "animal"]), new $.Card("goat", "\u0628\u0632", "boz", 1, 1, 1, ["noun", "animal"]), new $.Card("sheep", "\u06af\u0648\u0633\u0641\u0646\u062f", "goosfand", 1, 1, 1, ["noun", "animal"]), new $.Card("duck", "\u0627\u0631\u062f\u06a9", "ordak", 1, 1, 1, ["noun", "animal"]), new $.Card("cow", "\u06af\u0627\u0648", "gav", 1, 1, 1, ["noun", "animal"]), new $.Card("fish", "\u0645\u0627\u0647\u06cc", "mahi", 1, 1, 1, ["noun", "animal"])];
});
Isolate.$lazy($, "workingDictionary", "workingDictionary", "get$workingDictionary", function() {
  return [];
});
