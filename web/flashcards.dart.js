...
Model: {"": "Object;localStorage,workingCards,allCards,currentCard,selectedSource,random,listeners",
  ...
  loadData$0: function() {
    ...
    for (t1 = new H.ListIterator(L.Data_getSeedData(), 286, 0, null); t1.moveNext$0();) {
